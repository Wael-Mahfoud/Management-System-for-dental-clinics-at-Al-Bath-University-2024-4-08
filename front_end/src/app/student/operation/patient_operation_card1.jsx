...
export default function PatientOperationCard1(item, index, setInfoMsg, setErrorMsg) {
                    ...
                    <div className='card-body d-flex flex-column justify-content-between col-7'>
                        <div>
                            ...
                            <h5>
                                ...
                                <span className='btn' onClick={() => router.push(`/user/profile?id=${item.patient_record.patient.id}`)}>
                                    <h5>{item.patient_record.patient.name}</h5>
                                </span>
                            </h5>
                            <h5>
                        ...
                        <div className='text-center'>
                            ...
                            <button className={`${buttonClass} btn-block text-light text-capitalize`} onClick={() => router.push('/user/profile?id=' + item.patient_record.patient.id)}>
                                {item.patient_record.patient.name} profile<i className="fa fa-user"></i>
                            </button>
