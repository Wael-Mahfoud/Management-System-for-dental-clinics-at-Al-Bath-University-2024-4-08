                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item">
                            <Link href="/student/student_records" passHref>
                                <div className="nav-link text-primary text-capitalize">your student records</div>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link href="/student/operation?type=doctor" passHref>
                        ...
                        <li className="nav-item">
                            <Link href="/student/patient_record_list?type=waiting" passHref>
                                <div className="nav-link text-primary text-capitalize">waited patient card</div>
                            </Link>
                        </li>

                        <li className="nav-item">
                            <Link href="/student/patient_record_list?type=all" passHref>
                                <div className="nav-link text-primary text-capitalize">All patient card</div>
                            </Link>
                        </li>
